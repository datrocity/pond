...
class NumpyArrayArtifactUncompressed(Artifact):
...
global_artifact_registry.register(artifact_class=NumpyArrayArtifactUncompressed, data_class=np.ndarray, format='npy')
